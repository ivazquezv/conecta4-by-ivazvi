...
public final class DiagonalWinRule extends BaseWinRule {
     ...
     *              porque debemos comprobar que las fichas consecutivas sean del mismo jugador
     ...
     * @return true si hay 4 o más consecutivas del mismo color, false en caso contrario
     */
    private boolean checkDiagonal(Board board, DiscColor color, int row, int col, int rowDir, int colDir) {
        ...
        // Avanzar en la dirección indicada (ej. abajo-derecha o arriba-derecha)
        ...
        // Retroceder en la dirección opuesta (ej. arriba-izquierda o abajo-izquierda)
